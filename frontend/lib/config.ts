...
export const ROLES: Record<string, any> = {
  ...
  dept_head: { label: "部門主管", icon: "📋", color: C.amber, desc: "查閱本部門去識別化統計及OKR", perms: ["assess", "view_own", "dl_own", "view_history", "submit_org", "view_dept_okr", "dl_dept", "view_appt", "view_date_report", "health_self", "health_aggregate", "org_analytics"] },
  admin: { label: "單位平台管理者", icon: "🔐", color: C.plum, desc: "HR人資高管／財務高管／負責人", perms: ["assess", "view_own", "dl_own", "view_history", "view_org", "dl_org", "view_okr", "manage_okr", "view_appt", "manage_appt", "dl_appt", "view_kpi", "edit_params", "view_date_report", "dl_date_report", "view_esg", "manage_reibi", "health_aggregate", "manage_ohs", "org_analytics", "generate_org_reports"] },
  occupational_health: { label: "臨場醫護人員", icon: "🩺", color: C.coral, desc: "僅存取去識別化 roster 與過負荷面談記錄", perms: ["oh_interview"] },
  reibi_super: { label: "REIBI 內部超級管理者", icon: "🛡️", color: C.teal, desc: "跨企業營運、財務、夥伴與資料搬移", perms: ["manage_reibi", "health_aggregate", "manage_ohs", "cross_org_analytics"] },
};
